...
const paths = {
  ...
  tooth:
    'M17 2c-1.7 0-2.6.8-3.4 1.3-.5.3-1 .7-1.6.7s-1.1-.4-1.6-.7C9.6 2.8 8.7 2 7 2 4.5 2 3 4 3 6.5c0 1.8.7 3.4 1.2 5.5.5 2 .6 4 .9 5.9C5.4 20.5 5.7 22 7 22c1.4 0 1.6-2 2-4 .4-1.8.8-3 3-3s2.6 1.2 3 3c.4 2 .6 4 .9 5.9C15.4 20.5 15.7 22 17 22c1.3 0 1.6-1.5 1.9-2.1.3-1.9.4-3.9.9-5.9.5-2.1 1.2-3.7 1.2-5.5C21 4 19.5 2 17 2Z',
  sparkle:
  ...
  shieldCheck:
    'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z M9 11l2 2 4-4',
  align:
